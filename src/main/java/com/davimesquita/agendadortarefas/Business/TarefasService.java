...
import com.davimesquita.agendadortarefas.Business.Mapper.TarefaUpdateConverter;
...
import com.davimesquita.agendadortarefas.Infrastructure.Exceptions.ResourceNotFoundException;
...
public class TarefasService {
    ...
    public void deletaTarefaPorId(String id) {
        try {
            ...
            throw new ResourceNotFoundException("Erro : Não foi possível deletar tarefa por id, id inexistente" + id, e.getCause());
        }
    }
    ...
    public TarefasDTO alteraStatus(StatusNotificacaoEnum status, String id) {
        try {
            ...
            throw new ResourceNotFoundException("Erro : não foi possível realizar a alteração do status da tarefa" + e.getCause());
        }
    }
